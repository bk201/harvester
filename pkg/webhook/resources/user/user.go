...
func (m *userMutator) Info() types.ValidatorInfo {
...
func (m *userMutator) Create(request *webhook.Request, newObj runtime.Object) (types.PatchOps, error) {
	logrus.Debug("entering userMutator.Create")
	user := newObj.(*v1beta1.User)
	return m.createOrUpdateUser(user, true)
}

func (m *userMutator) Update(request *webhook.Request, oldObj runtime.Object, newObj runtime.Object) (types.PatchOps, error) {
	logrus.Debug("entering userMutator.Update")
	user := newObj.(*v1beta1.User)
	return m.createOrUpdateUser(user, false)
}

func (m *userMutator) Delete(request *webhook.Request, oldObj runtime.Object) (types.PatchOps, error) {
