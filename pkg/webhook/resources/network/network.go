...
func (v *networkAttachmentDefinitionValidator) Info() types.ValidatorInfo {
	return types.ValidatorInfo{
		GroupName:  cni.GroupName,
...
func (v *networkAttachmentDefinitionValidator) Create(request *webhook.Request, newObj runtime.Object) error {
	logrus.Debug("entering networkAttachmentDefinitionValidator.Create")
...
func (v *networkAttachmentDefinitionValidator) Delete(request *webhook.Request, oldObj runtime.Object) error {
	logrus.Debug("entering networkAttachmentDefinitionValidator.Delete")
